...
- Claude Code installé ([télécharger](https://claude.ai/code))
- Node.js 18+ installé
...
Si la configuration automatique n'a pas fonctionné, configurez manuellement :
...
2. Vérifiez que la syntaxe de `mcp.json` est du JSON valide
