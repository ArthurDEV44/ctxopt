...
description: Référence complète des 19 outils d'optimisation Distill
---

# Référence des outils MCP

Distill fournit 19 outils pour optimiser l'utilisation des tokens LLM. Chaque outil est conçu pour des cas d'usage spécifiques.
