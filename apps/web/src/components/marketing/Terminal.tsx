            ...
            <div className="flex items-center justify-between border-b border-white/5 px-4 py-3">
                <div className="flex items-center gap-2">
                    <div className="flex gap-1.5">
                        <div className="h-3 w-3 rounded-full bg-red-500/20 box-border border-red-500/50"></div>
                        <div className="h-3 w-3 rounded-full bg-yellow-500/20 box-border border-yellow-500/50"></div>
                        <div className="h-3 w-3 rounded-full bg-green-500/20 box-border border-green-500/50"></div>
                    </div>
            ...
            <div className="p-4 font-mono text-sm">
                <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-2 text-slate-300">
                        ...
                        <span>{command}</span>
                        <span className="h-4 w-2 animate-pulse bg-slate-500"></span>
                    </div>
                    <button
                ...
                <div className="mt-2 space-y-1 text-slate-500 opacity-50 select-none">
